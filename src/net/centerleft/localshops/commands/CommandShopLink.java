                ...
                if (shop == null) {
                    ...
                    for ( World world : plugin.getServer().getWorlds() ) {
                        if (world.getName() == worldName) {
                            if (Config.GLOBAL_SHOPS.containsKey(worldName)) {
                                if (Config.GLOBAL_SHOPS.get(worldName) == shop.getUuid()) {
                                ...
                                Config.GLOBAL_SHOPS.put(worldName, shop.getUuid());
                                LocalShops.getProperties().setUuid(worldName + "-shop-UUID", shop.getUuid());
